...
// !!! REEMPLAZA ESTO CON EL "EXTERNAL DATABASE URL" QUE COPIASTE DE RENDER !!!
const POSTGRES_URL = "const { Telegraf } = require('telegraf');
const axios = require('axios');
const { Pool } = require('pg');
const express = require('express');
...
// !!! REEMPLAZA ESTO CON EL "EXTERNAL DATABASE URL" QUE COPIASTE DE RENDER !!!
const POSTGRES_URL = "TU_EXTERNAL_DATABASE_URL_AQUI";
